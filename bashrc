...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[38;5;27m\][\A]\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
alias la='ls -A'
alias l='ls -CF'
alias lah='ls -lAh'	# list all, human readable sizes
